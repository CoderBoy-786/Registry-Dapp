...
const projectId = '2EmBrnZ2GnfgUMsIQMldL6F7sLf'
const projectSecret = '150e8c05a8126e86b19c353500c34ae1'
...
const FormRightWrapper = () => {
  ...
  const uploadFiles = async (e) => {
    ...
    if(Handler.form.documentInformation !== "") {
      try {
        const added = await client.add(Handler.form.documentInformation);
        Handler.setStoryUrl(added.path)
      } catch (error) {
        toast.warn(`Error Uploading Document information`);
      }
    }
  ...
  return (
    <FormRight>
        ...
        {/* <FormRow> */}
          ...
          {/* <RowSecondInput> */}
            ...
            <Select onChange={Handler.FormHandler} value={Handler.form.category} name="category">
              ...
              <option>FirstTimesell</option>
              <option>GovernmentProperty</option>
            </Select>
          {/* </RowSecondInput> */}
        {/* </FormRow> */}
      </FormInput>
      ...
      {uploadLoading == true ? <Button><TailSpin color='#fff' height={20} /></Button> :
       ...
       <Button onClick={Handler.startUpload}>
        Start Campaign
      </Button>
    </FormRight>
  )
